...
// End -->
    ...
    <title>My JSP 'STxt.jsp' starting page</title>
  ...
  <body bgcolor="#208030" onLoad="snow()">
  <% 
     System.out.println("学生成功0!!!");
...
<table>
            ...
            <%
            System.out.println("学生成功5!!!");
            Iterator<teacher> iter2=teacherlist.iterator(); 
            System.out.println("学生成功6!!!");
            while(iter2.hasNext()){
            teacher tmpname = (teacher)iter2.next();
             %>
             <option value ="<%=tmpname.getname()%>"><%=tmpname.gettruename()%></option>
             <% 
             }
             %>
            </select>
            ...
            <td>
              	<input type="submit"  name="deal1"  value="查询该老师" style="width: 100px; ">
      	    </td>
            </tr>
            </table>
...
<form  name="form" method="post" action="s_deal2">
   ...
   日
    ...
    <table width="600" border="1" align="center" height="">
    <%
      for ( int timetmp = 8; timetmp < 17; timetmp++)
      {
      System.out.println("学生成功3!!!");
      %>
      <tr>
     ...
     while(iter1.hasNext()){
    		...
    		if(Integer.parseInt(tmpw[0]) == timetmp)
    		{
    		   ...
    		   String idname = et.gett_name();
    		   tch = database.queryt_name(idname);
          ...
          <tr>
    		   ...
    		   <td>老师：</td>
    		   <td>
    		   <input type="text" name="xianshi5" style="width: 50px;" value="<%=tch.gettruename()%>" >
    		   </td>
    		   <td>备注：</td>
    		   <td>
