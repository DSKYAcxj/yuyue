...
//-->
  ...
  <form  name="form" method="post" action="s_deal">
    ...
    <tr>
    <td>
    <input type="submit"  name="datedeal4"  value="往前翻一天" style="width: 100px; ">
    </td>
    <td>
   ...
   日
    ...
    <td>
    <input type="submit"  name="datedeal5"  value="往后翻一天" style="width: 100px; ">
    </td>
    <td>
    <input type="submit"  name="datedeal6"  value="查询所填时间" style="width: 100px; ">
    </td>
    </tr>
    </table>
...
备注：
        ...
        <td>
        <input type="text" name="beizhu" style="width: 250px; ">
        </td>
        </tr>
        </table>
        <table>
            ...
            <td>
      	    ...
      	    <td>
      	        <input type="submit"  name="deal2"  value="返回" style="width: 100px; ">
           	</td>
            </tr>
            </table>
    </form>
